...
public function gettour_guider(){
    $this->db->query("SELECT * FROM tour_guide");
    return $this->db->resultSet();
}

//find guider by email
public function findtour_guiderByEmail($email){
 ...
 // Get user by ID
 public function gettour_guiderById($id){
