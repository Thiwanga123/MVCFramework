...
<div class="sidebar">
        <div class="top">
            <a href="#" class="logo">
                ...
                <div class="logo-name">JOURNEY  <br><span>BEYOND <br><span>Guider</span></div>
        ...
        <ul class="side-menu">
            <li class=><a href="<?php echo URLROOT;?>/tour_guides/Dashboard">
                ...
                <li><a href="<?php echo URLROOT;?>/tour_guides/Bookings">
                ...
                <li><a href="<?php echo URLROOT;?>/tour_guides/Update_Availability">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M160-160v-516L82-846l72-34 94 202h464l94-202 72 34-78 170v516H160Zm240-280h160q17 0 28.5-11.5T600-480q0-17-11.5-28.5T560-520H400q-17 0-28.5 11.5T360-480q0 17 11.5 28.5T400-440ZM240-240h480v-358H240v358Zm0 0v-358 358Z"/></svg>Update Availability</a></li>
                <li><a href="<?php echo URLROOT;?>/tour_guides/Mypayments">
                ...
                <li><a href="<?php echo URLROOT;?>/tour_guides/Reviews">
                ...
                <li><a href="<?php echo URLROOT;?>/tour_guides/bankdetails">
            ...
            <li><a href="<?php echo URLROOT;?>/tour_guides/Profile">
