                ...
                <div class="view-container">
                    <div class="container">
                        <div class="header">
                            ...
                            <div class="back-button"><a href="<?php echo URLROOT;?>/users/guider"> Back to Guiders</a></div>
                        </div>
                    <!-- Navigation Tabs -->
                        <div class="menu-bar">
                        ...
                        <div class="tab-content" id="details">
                            <?php include_once APPROOT . '/views/users/includes/guider/details.php'; ?> 
                        </div>

                        <div class="tab-content" id="reviews" style="display: none;">
                            <?php include_once APPROOT . '/views/users/includes/guider/reviews.php'; ?> 
                        </div>

                        <div class="tab-content" id="book-now" style="display: none;">
                            <?php include_once APPROOT . '/views/users/includes/guider/bookings.php'; ?> 
                        </div>
                    </div>
                </div>  
            </main>
