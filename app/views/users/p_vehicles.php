     ...
     <main>
            <div class="vehicle-container">
                <div class="filter">
                    ...
                    <a href="<?php echo URLROOT;?>/users/planaccomodation" class="nav-button prev-button">
                    ...
                    <a href="<?php echo URLROOT;?>/users/planguides" class="nav-button next-button">
                        <span>Next</span>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
                ...
                <div class="filter-bar">
                    ...
                    <div class="filter-item">
                        ...
                        <input type="date" id="eDate" placeholder="Select End Date" value="<?= $endDate ?>">
                        </div>
                        <span class="error-message" min="<?= $today ?>" id="eDate-error"></span>
                    </div>
