...
<div class="sidebar">
        ...
        <ul class="side-menu">
            <li><a href="<?php echo URLROOT;?>/equipment_suppliers/Dashboard">
            ...
            <li><a href="<?php echo URLROOT;?>/equipment_suppliers/Reviews">
                ...
                <li><a href="<?php echo URLROOT;?>/equipment_suppliers/bankdetails">
