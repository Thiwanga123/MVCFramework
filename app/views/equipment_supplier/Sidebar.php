...
<div class="sidebar">
        ...
        <ul class="side-menu">
            <li class="active"><a href="<?php echo URLROOT;?>/Supplier/Dashboard">
            ...
            <li><a href="<?php echo URLROOT;?>/Supplier/MyInventory">
            ...
            <li><a href="<?php echo URLROOT;?>/Supplier/Orders">
            ...
            <li><a href="<?php echo URLROOT;?>/Supplier/Reviews">
            ...
            <li><a href="<?php echo URLROOT;?>/Supplier/Notifications">
            ...
            <li><a href="<?php echo URLROOT;?>/Supplier/Profile">
