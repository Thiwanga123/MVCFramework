            ...
            <form id="editProductForm" action="<?php echo URLROOT; ?>/product/updateProduct" method = "post" enctype="multipart/form-data"> 
                <div class="body">
                    <div class="left">
                        ...
                        <input type="text" id="productName" name="productName" value="<?php echo $product->product_name; ?>" required>
                
                        <label for="productRate">Rate</label>
                        <input type="text" id="productRate" name="productPrice" value="<?php echo $product->rate; ?>" required>
                
                        <label for="productCategory">Category:</label>
                        <select id="productCategory" name="productCategory" required style="width: 100%; max-width: 300px; height: 40px;">
                                <option value="<?php echo $product->category_name; ?>" disabled selected>Select a category</option>
                        ...
                        <input type="number" id="stockQuantity" name="stockQuantity" min="1" max="15" value="<?php echo $product->quantity; ?>" required>
                            
                    </div>

                    <div class="right">
                        <label for="productDescription">Description</label>
                        <textarea id="productDescription" name="productDescription" value = "<?php echo $product->description; ?>" rows="9" required></textarea>
