...
<div class="sidebar">
        ...
        <ul class="side-menu">
            <li><a href="<?php echo URLROOT;?>/accomadation/Dashboard">
            ...
            <li><a href="<?php echo URLROOT;?>/accomadation/Profile">
            ...
            <li><a href="<?php echo URLROOT; ?>/accomadation/logout" class="logout">
