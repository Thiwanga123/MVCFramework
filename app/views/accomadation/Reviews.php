                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>E101</td>
                            <td class="rev">I’ve been on many tours, but this one stood out because of our exceptional Hotel.</td>
                            <td>2024/05/05</td>
                            <td> <p>⭐⭐⭐⭐⭐</p></td>
                            <td class="Action">
                                <a href="#" class="more">
                        ...
                        <tr>
                            ...
                            <td>E102</td>
                            <td class="rev">Excellent experience!</td>
                            <td>2024/07/08</td>
                            <td> <p>⭐⭐⭐⭐⭐</p></td>
                            <td class="Action">
                                <a href="#" class="more">
                        ...
                        <tr>
                            ...
                            <td>E103</td>
                            <td class="rev">Best Bunglow that I felt. Highly Recommanded.</td>
                            <td>2024/10/05</td>
                            <td> <p>⭐⭐⭐⭐⭐</p></td>
                            <td class="Action">
                                <a href="#" class="more">
