...
<div class="sidebar">
        ...
        <ul class="side-menu">
            <li class="active"><a href="<?php echo URLROOT;?>/Transport_supplier/Dashboard">
            ...
            <li><a href="<?php echo URLROOT;?>/Transport_supplier/MyInventory">
            ...
            <li><a href="<?php echo URLROOT;?>/Transport_supplier/Orders">
            ...
            <li><a href="<?php echo URLROOT;?>/Transport_supplier/Reviews">
            ...
            <li><a href="<?php echo URLROOT;?>/Transport_supplier/Notifications">
            ...
            <li><a href="<?php echo URLROOT;?>/Transport_supplier/MyProfile">
